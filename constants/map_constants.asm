...
; - scripts and events (see data/maps/scripts.asm)
	...
	map_const POKEMON_TOWER_OUTSIDE,					   11, 16 ; 15
	map_const POKEMON_TOWER_HUB,							7,   8; 16
	map_const POKEMON_TOWER_1F,								7,   7; 17
	map_const POKEMON_TOWER_2F,								7,   7; 18
	map_const POKEMON_TOWER_3F,								7,   7; 19
	map_const POKEMON_TOWER_4F,								5,   5; 20
	...
	map_const ROUTE_1,                                     13, 13 ;  3
	map_const NEW_BARK_TOWN,                               13,  9 ;  4
	map_const CEDARS_LAB,                                   5,  6 ;  5
	map_const PLAYERS_HOUSE_1F,                             5,  4 ;  6
	map_const PLAYERS_HOUSE_2F,                             4,  3 ;  7
	map_const PLAYERS_NEIGHBORS_HOUSE,                      4,  4 ;  8
	map_const ROUTE_26_HEAL_HOUSE,                          4,  4 ;  9
	map_const DAY_OF_WEEK_SIBLINGS_HOUSE,                   4,  4 ; 10
	map_const ROUTE_27_SANDSTORM_HOUSE,                     4,  4 ; 11
	map_const ROUTE_1_ROUTE_2_GATE,  					    4,  3 ; 12
	map_const MT_WILDERNESS,						       12, 14 ; 13		                    
	...
	map_const SILPH_STORE,                                  6,  6 ; 16

	newgroup                                                      ; 26

	map_const ROUTE_30,                                    10, 27 ;  1
	map_const ROUTE_31,                                    20,  9 ;  2
	map_const HARPERS_TOWN,                                14, 14 ;  3
	map_const HARPERS_MART,                                 6,  4 ;  4
	map_const CHERRYGROVE_POKECENTER_1F,                    5,  4 ;  5
	map_const CHERRYGROVE_GYM_SPEECH_HOUSE,                 4,  4 ;  6
	map_const MR_JACKSONS_HOUSE,                            4,  4 ;  7
	map_const ROUTE_30_BERRY_HOUSE,                         4,  4 ;  9
	map_const MR_POKEMONS_HOUSE,                            4,  4 ; 10
	map_const ROUTE_31_VIOLET_GATE,                         5,  4 ; 11
	map_const HARPERS_GYM,                      	        7,  9 ; 12
	map_const HARPERS_DUNKER_GATE,							4,  4 ; 13
	map_const HARPERS_DUNKER_GATE_2F,						3,  3 ; 14
	map_const DUNKER_FOREST,							   18, 12 ; 15		
	map_const URSARING_RUN, 							   18, 09 ; 16
	map_const SHENDO_DUNKER_GATE, 							5,  4 ; 17

	newgroup

	map_const SHENDO_CITY,								   18, 20 ;  1
