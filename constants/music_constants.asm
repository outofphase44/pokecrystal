...
; Music indexes (see audio/music_pointers.asm)
	...
	const MUSIC_PROF_CEDAR                   ; 32
	const MUSIC_DARK_CAVE                    ; 33
	const MUSIC_ROUTE_1                      ; 34
	...
	const MUSIC_BUG_CATCHING_CONTEST_RANKING ; 58        ; 59
...
; new to Crystal
	...
	const MUSIC_SUICUNE_BATTLE				 ; 67
	const MUSIC_SLATEPORT_CITY               ; 6b
	const MUSIC_PETALBURG_CITY				 ; 6c
	const MUSIC_SS_ANNE
	const MUSIC_CINNABAR
	const MUSIC_ROUTE_24
	const MUSIC_CERULEAN
