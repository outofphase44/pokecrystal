...
; wCedarsLabSceneID
	const_def 1
	const SCENE_CEDARSLAB_CANT_LEAVE            ; 1
	const SCENE_CEDARSLAB_NOTHING               ; 2
	const SCENE_CEDARSLAB_MEET_OFFICER          ; 3
	const SCENE_CEDARSLAB_UNUSED                ; 4
	const SCENE_CEDARSLAB_AIDE_GIVES_POTION     ; 5
	const SCENE_CEDARSLAB_AIDE_GIVES_POKE_BALLS ; 6

; wRoute1SceneID
	const_def
	const SCENE_Route1_NOTHING        ; 0
	const SCENE_Route1_CATCH_TUTORIAL ; 1

; wHarpersTownSceneID
	const_def
	const SCENE_HARPERSTOWN_NOTHING    ; 0
	const SCENE_HARPERSTOWN_MEET_RIVAL ; 1
