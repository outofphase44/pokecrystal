...
; HMs (EVENT_GOT_HM07_WATERFALL is with the Johto itemballs)
	...
	const EVENT_016
; Rods
	const EVENT_GOT_RIVER_ROD
	const EVENT_GOT_GOOD_ROD
	const EVENT_GOT_SUPER_ROD
; Johto story events
	const EVENT_GOT_A_POKEMON_FROM_CEDAR
	const EVENT_GOT_MAGMAR_FROM_CEDAR
	const EVENT_GOT_STARYU_FROM_CEDAR
	const EVENT_GOT_ELECTABUZZ_FROM_CEDAR
	const EVENT_GOT_MYSTERY_EGG_FROM_MR_POKEMON
	const EVENT_GAVE_MYSTERY_EGG_TO_CEDAR
	...
	const EVENT_GOT_SS_TICKET_FROM_CEDAR
	...
	const EVENT_HERDED_CHARMANDER
	const EVENT_FOUGHT_SUDOWOODO
	const EVENT_CLEARED_SLOWPOKE_WELL
	const EVENT_REFUSED_TO_TAKE_EGG_FROM_CEDARS_AIDE
	const EVENT_GOT_TOGEPI_EGG_FROM_CEDARS_AIDE
	...
	const EVENT_SHOWED_TOGEPI_TO_CEDAR
	const EVENT_GOT_EVERSTONE_FROM_CEDAR
...
; Johto hidden items
	...
	const EVENT_DUNKER_FOREST_HIDDEN_ETHER
	const EVENT_DUNKER_FOREST_HIDDEN_SUPER_POTION
	const EVENT_DUNKER_FOREST_HIDDEN_FULL_HEAL
...
; More Johto story events
	...
	const EVENT_FOUGHT_SCIZOR
	const EVENT_FOUGHT_MAROWAK
...
; Picnicker
	...
	const EVENT_BEAT_PICNICKER_RUBY
; Guitarist
...
; Bug Catcher
	...
	const EVENT_BEAT_BUG_CATCHER_PERCY
; Officer
...
; Crystal-exclusive trainer flags
	...
	const EVENT_BEAT_BUG_CATCHER_KENNETH
...
; Johto itemballs
	const EVENT_MAGMAR_POKEBALL_IN_CEDARS_LAB
	const EVENT_STARYU_POKEBALL_IN_CEDARS_LAB
	const EVENT_ELECTABUZZ_POKEBALL_IN_CEDARS_LAB
	const EVENT_VIOLET_CITY_PP_UP
	const EVENT_VIOLET_CITY_RARE_CANDY
	const EVENT_LAKE_OF_RAGE_ELIXER
	const EVENT_LAKE_OF_RAGE_TM_KNEE_STRIKE
	...
	const EVENT_BURNED_TOWER_B1F_TM_DREAM_EATER
	const EVENT_NATIONAL_PARK_PARLYZ_HEAL
	const EVENT_NATIONAL_PARK_TM_TOMBSTONE
	...
	const EVENT_SLOWPOKE_WELL_B2F_TM_DREADNAUGHT
	...
	const EVENT_DUNKER_FOREST_REVIVE
...
; Johto people
	...
	const EVENT_RIVAL_HARPERS_TOWN
	...
	const EVENT_ILEX_FOREST_CHARMANDER
	...
	const EVENT_CHARCOAL_KILN_CHARMANDER
	...
	const EVENT_MR_JACKSON_IN_HIS_HOUSE
	const EVENT_MR_JACKSON_VISIBLE_IN_CHERRYGROVE
	const EVENT_CEDARS_AIDE_IN_VIOLET_POKEMON_CENTER
	const EVENT_CEDARS_AIDE_IN_LAB
	const EVENT_COP_IN_CEDARS_LAB
	...
	const EVENT_GATE_OF_JOHTO_0F_SCIZOR
	const EVENT_POKEMON_TOWER_4F_MAROWAK
...
; Kanto itemballs
	...
	const EVENT_ROCK_TUNNEL_1F_TM_PETRIFY
...
; New to Crystal
	...
	const EVENT_DUNKER_FOREST_X_ATTACK
	const EVENT_DUNKER_FOREST_ANTIDOTE
	const EVENT_DUNKER_FOREST_ETHER
