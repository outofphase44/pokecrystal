...
; - BattleAnimations (see data/moves/animations.asm)
	...
	const MEGA_KICK    ; 19
	const JUMP_KICK    ; 1a
	const KNEE_STRIKE ; 1b
	const CROSS_PUNCH  ; 1c
	const HEADBUTT     ; 1d
	...
	const PECK         ; 40
	const DRILL_PECK   ; 41
	const JAGGED_EDGE   ; 42
	const LOW_KICK     ; 43
	const COUNTER      ; 44
	const SEISMIC_TOSS ; 45
	const STRENGTH     ; 46
	const ECTOPLASM       ; 47
	const BLOOM_BURST   ; 48
	const LEECH_SEED   ; 49
	const GROWTH       ; 4a
	const RAZOR_LEAF   ; 4b
	const SOLARBEAM    ; 4c
	...
	const MIMIC        ; 66
	const SCREECH      ; 67
	const BULLET_PUNCH  ; 68
	const RECOVER      ; 69
	const HARDEN       ; 6a
	const SCALD     ; 6b
	const ANCIENT_FIRE  ; 6c
