; SFX indexes (see audio/sfx_pointers.asm)
	...
	const SFX_POLARITY                        ; 3b
	const SFX_VINE_WHIP                   ; 3c
	const SFX_TWIST_KICK                 ; 3d
	...
	const SFX_NIGHT_SLASH                        ; 45
	const SFX_JUMP_KICK                   ; 46
	const SFX_STOMP                       ; 47
	const SFX_NOVA_BOMB                   ; 48
	const SFX_KARATE_CHOP                 ; 49
	const SFX_JAGGED_EDGE                  ; 4a
	...
	const SFX_BULLDOZE                   ; 59
	const SFX_SHARPEN                     ; 5a
	const SFX_BUG_BITE                    ; 5b
	const SFX_SING                        ; 5c
	...
	const SFX_INFERNO                 ; 79
	const SFX_NIGHTMARE                   ; 7a
	const SFX_SNORE                       ; 7b
	const SFX_QUIVER_DANCE                  ; 7c
	const SFX_QUIVER_DANCE_2                ; 7d
