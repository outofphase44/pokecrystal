...
; bit 5: Submission around vertically
; bit 4: Submission around horizontally
...
wCedarsLabSceneID::                                 db ; d987
wPlayersHouse1FSceneID::                          db ; d988
wRoute1SceneID::                                 db ; d989
wHarpersTownSceneID::                         db ; d98a
