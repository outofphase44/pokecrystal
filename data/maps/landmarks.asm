...
; entries correspond to constants/landmark_constants.asm
	...
	landmark 118, 115, GateOfJohtoName
	landmark 100, 100, HarpersTownName
	...
	landmark 135, 75,  PokemonTowerName

NewBarkTownName:     db "NEW BARK¯TOWN@"
HarpersTownName: db "CHERRYGROVE¯CITY@"
...
GateOfJohtoName:     db "GATE OF JOHTO@"
