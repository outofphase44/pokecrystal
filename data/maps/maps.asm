...
MapGroup_Olivine:
	...
	map Route38EcruteakGate, TILESET_GATE, GATE, LANDMARK_ROUTE_38, MUSIC_PETALBURG_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route38, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_38, MUSIC_PETALBURG_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route39, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_39, MUSIC_PETALBURG_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map OlivineCity, TILESET_JOHTO, TOWN, LANDMARK_OLIVINE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE

MapGroup_Mahogany:
	map MahoganyRedGyaradosSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_MAHOGANY_TOWN, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map MahoganyTown, TILESET_JOHTO, TOWN, LANDMARK_MAHOGANY_TOWN, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Dungeons:
	...
	map BurnedTower1F, TILESET_TOWER, DUNGEON, LANDMARK_BURNED_TOWER, MUSIC_VIOLET_CITY, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map BurnedTowerB1F, TILESET_CAVE, CAVE, LANDMARK_BURNED_TOWER, MUSIC_VIOLET_CITY, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map NationalPark, TILESET_PARK, ROUTE, LANDMARK_NATIONAL_PARK, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map NationalParkBugContest, TILESET_PARK, ROUTE, LANDMARK_NATIONAL_PARK, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map OlivineLighthouse1F, TILESET_LIGHTHOUSE, DUNGEON, LANDMARK_LIGHTHOUSE, MUSIC_PETALBURG_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineLighthouse2F, TILESET_LIGHTHOUSE, DUNGEON, LANDMARK_LIGHTHOUSE, MUSIC_PETALBURG_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineLighthouse3F, TILESET_LIGHTHOUSE, DUNGEON, LANDMARK_LIGHTHOUSE, MUSIC_PETALBURG_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineLighthouse4F, TILESET_LIGHTHOUSE, DUNGEON, LANDMARK_LIGHTHOUSE, MUSIC_PETALBURG_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OlivineLighthouse5F, TILESET_LIGHTHOUSE, DUNGEON, LANDMARK_LIGHTHOUSE, MUSIC_PETALBURG_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map SilverCaveRoom1, TILESET_DARK_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_PETALBURG_CITY, TRUE, PALETTE_DARK, FISHGROUP_LAKE
	map SilverCaveRoom2, TILESET_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_PETALBURG_CITY, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SilverCaveRoom3, TILESET_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_PETALBURG_CITY, TRUE, PALETTE_DAY, FISHGROUP_LAKE
	map SilverCaveItemRooms, TILESET_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_PETALBURG_CITY, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	...
	map DiglettsCave, TILESET_CAVE, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_PETALBURG_CITY, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map MountMoon, TILESET_CAVE, CAVE, LANDMARK_MT_MOON, MUSIC_PETALBURG_CITY, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map UndergroundPath, TILESET_UNDERGROUND, GATE, LANDMARK_UNDERGROUND_PATH, MUSIC_PETALBURG_CITY, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map RockTunnel1F, TILESET_DARK_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_PETALBURG_CITY, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map RockTunnelB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_PETALBURG_CITY, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map SafariZoneFuchsiaGateBeta, TILESET_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	...
	map Route19FuchsiaGate, TILESET_GATE, GATE, LANDMARK_ROUTE_19, MUSIC_VIOLET_CITY,FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SeafoamGym, TILESET_CAVE, INDOOR, LANDMARK_SEAFOAM_ISLANDS, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map Route19, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_19, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route20, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_20, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route21, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_21, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map CinnabarIsland, TILESET_KANTO, TOWN, LANDMARK_CINNABAR_ISLAND, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN

MapGroup_Cerulean:
	map CeruleanGymBadgeSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanPoliceStation, TILESET_HOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanTradeSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeruleanMart, TILESET_MART, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map PowerPlant, TILESET_FACILITY, INDOOR, LANDMARK_POWER_PLANT, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_25, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route4, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_4, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route9, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_9, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route10North, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_10, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route24, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_24, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route25, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_25, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map CeruleanCity, TILESET_KANTO, TOWN, LANDMARK_CERULEAN_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup_Azalea:
	...
	map Route33, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_33, MUSIC_PETALBURG_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Violet:
	map Route32, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_32, MUSIC_PETALBURG_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POLIWHIRL
...
MapGroup_Vermilion:
	map Route6, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_6, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map Route6SaffronGate, TILESET_GATE, GATE, LANDMARK_ROUTE_6, MUSIC_VIOLET_CITY,FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route6UndergroundPathEntrance, TILESET_GATE, GATE, LANDMARK_ROUTE_6, MUSIC_VIOLET_CITY,FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	map Route3, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_3, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PewterCity, TILESET_KANTO, TOWN, LANDMARK_PEWTER_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PewterNidoranSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterGym, TILESET_TOWER, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMart, TILESET_MART, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map PewterPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterSnoozeSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_FastShip:
	...
	map MountMoonSquare, TILESET_KANTO, ROUTE, LANDMARK_MT_MOON, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MountMoonGiftShop, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_MT_MOON, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	map Route13, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_13, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_POLIWHIRL_NO_SWARM
	...
	map Route18, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_18, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FuchsiaCity, TILESET_KANTO, TOWN, LANDMARK_FUCHSIA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_GYARADOS
	map FuchsiaMart, TILESET_MART, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneMainOffice, TILESET_GAME_CORNER, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaGym, TILESET_LAB, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsBrothersHouse, TILESET_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map FuchsiaPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneWardensHome, TILESET_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route15FuchsiaGate, TILESET_GATE, GATE, LANDMARK_ROUTE_15, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Lavender:
	map Route8, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_8, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route12, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_POLIWHIRL_NO_SWARM
	map Route10South, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_10, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	...
	map Route8SaffronGate, TILESET_GATE, GATE, LANDMARK_ROUTE_8, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route12SuperRodHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_12, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Celadon:
	map Route7, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_7, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route16, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_16, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route17, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_17, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map CeladonCity, TILESET_KANTO, TOWN, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map CeladonDeptStore1F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore2F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore3F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore4F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore5F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore6F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStoreElevator, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansion1F, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansion2F, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansion3F, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansionRoof, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansionRoofHouse, TILESET_HOUSE, INDOOR, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeladonPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeladonGameCornerPrizeRoom, TILESET_GAME_CORNER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonGym, TILESET_TRAIN_STATION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonCafe, TILESET_GAME_CORNER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route16FuchsiaSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_16, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route16Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_16, MUSIC_VIOLET_CITY,FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route7SaffronGate, TILESET_GATE, GATE, LANDMARK_ROUTE_7, MUSIC_VIOLET_CITY,FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route17Route18Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_17, MUSIC_VIOLET_CITY,FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map Route22, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_22, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_POND
	map ViridianCity, TILESET_KANTO, TOWN, LANDMARK_VIRIDIAN_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map ViridianGym, TILESET_TRAIN_STATION, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianNicknameSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrainerHouse1F, TILESET_HOUSE, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrainerHouseB1F, TILESET_FACILITY, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianMart, TILESET_MART, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ViridianPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route2NuggetHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_2, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_NewBark:
	...
	map Route1, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_1, MUSIC_ROUTE_24, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map NewBarkTown, TILESET_JOHTO, TOWN, LANDMARK_NEW_BARK_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map CedarsLab, TILESET_LAB, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_PROF_CEDAR, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersHouse2F, TILESET_PLAYERS_ROOM, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersNeighborsHouse, TILESET_HOUSE, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route1Route2Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_1, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MtWilderness, TILESET_CAVE,CAVE, LANDMARK_VIOLET_CITY, MUSIC_DARK_CAVE, TRUE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Saffron:
	map Route5, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_5, MUSIC_VIOLET_CITY,FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SaffronCity, TILESET_KANTO, TOWN, LANDMARK_SAFFRON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FightingDojo, TILESET_TRAIN_STATION, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronGym, TILESET_UNDERGROUND, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronMart, TILESET_MART, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map SaffronPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MrPsychicsHouse, TILESET_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronMagnetTrainStation, TILESET_TRAIN_STATION, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo1F, TILESET_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CopycatsHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CopycatsHouse2F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route5UndergroundPathEntrance, TILESET_GATE, GATE, LANDMARK_ROUTE_5, MUSIC_VIOLET_CITY,FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route5SaffronGate, TILESET_GATE, GATE, LANDMARK_ROUTE_5, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route5CleanseTagHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_5, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphStore, TILESET_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE

MapGroup_Cherrygrove:
	map Route30, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_30, MUSIC_PETALBURG_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route31, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_31, MUSIC_PETALBURG_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map HarpersTown, TILESET_JOHTO, TOWN, LANDMARK_HARPERS_TOWN, MUSIC_POKEMON_TALK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map HarpersMart, TILESET_MART, INDOOR, LANDMARK_HARPERS_TOWN, MUSIC_POKEMON_TALK, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygrovePokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_HARPERS_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygroveGymSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_HARPERS_TOWN, MUSIC_POKEMON_TALK, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MrJacksonsHouse, TILESET_HOUSE, INDOOR, LANDMARK_HARPERS_TOWN, MUSIC_POKEMON_TALK, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route30BerryHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_30, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MrPokemonsHouse, TILESET_FACILITY, INDOOR, LANDMARK_ROUTE_30, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route31VioletGate, TILESET_GATE, GATE, LANDMARK_ROUTE_31, MUSIC_PETALBURG_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map HarpersGym, TILESET_ELITE_FOUR_ROOM, INDOOR , LANDMARK_VIOLET_CITY, MUSIC_GYM, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map HarpersDunkerGate, TILESET_GATE, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_LAKE_OF_RAGE, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map HarpersDunkerGate2F, TILESET_GATE, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_LAKE_OF_RAGE, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map DunkerForest, TILESET_FOREST, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_POKEMON_LULLABY, FALSE, PALETTE_NITE, FISHGROUP_POND
	map UrsaringRun, TILESET_JOHTO, ROUTE, LANDMARK_VIOLET_CITY, MUSIC_ROUTE_24, FALSE, PALETTE_AUTO, FISHGROUP_SHORE	
	map ShendoDunkerGate, TILESET_GATE, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	
MapGroup_ShendoCity:
	map ShendoCity, TILESET_SHENDO, TOWN, LANDMARK_VIOLET_CITY, MUSIC_PETALBURG_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE