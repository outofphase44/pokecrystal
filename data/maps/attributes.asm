...
ENDM
	...
	map_attributes HarpersTown, HARPERS_TOWN, $05, WEST | EAST
	connection west, Route1, ROUTE_1, 2
	connection east, UrsaringRun, URSARING_RUN, 5

	map_attributes UrsaringRun, URSARING_RUN, $05, WEST
	connection west, HarpersTown, HARPERS_TOWN, -5
	...
	map_attributes Route1, ROUTE_1, $05, SOUTH |EAST
	connection south, NewBarkTown, NEW_BARK_TOWN, 1
	connection east,  HarpersTown, HARPERS_TOWN, -2

	map_attributes Route30, ROUTE_30, $05, NORTH | SOUTH
	connection north, Route31, ROUTE_31, -10
	connection south, HarpersTown, HARPERS_TOWN, -5
	...
	map_attributes Route12, ROUTE_12, $43, NORTH | SOUTH | WEST | EAST
	...
	map_attributes HarpersGym, HARPERS_GYM, $00, 0
	...
	map_attributes CedarsLab, CEDARS_LAB, $00, 0
	...
	map_attributes Route1Route2Gate, ROUTE_1_ROUTE_2_GATE, $00, 0
	...
	map_attributes SilphStore, SILPH_STORE, $00, 0
	...
	map_attributes HarpersMart, HARPERS_MART, $00, 0
	...
	map_attributes MrJacksonsHouse, MR_JACKSONS_HOUSE, $00, 0
	map_attributes Route30BerryHouse, ROUTE_30_BERRY_HOUSE, $00, 0
	map_attributes MrPokemonsHouse, MR_POKEMONS_HOUSE, $00, 0
	map_attributes Route31VioletGate, ROUTE_31_VIOLET_GATE, $00, 0
    map_attributes HarpersDunkerGate, HARPERS_DUNKER_GATE, $00, 0
	map_attributes HarpersDunkerGate2F, HARPERS_DUNKER_GATE_2F, $00, 0
	map_attributes DunkerForest, DUNKER_FOREST, $00,0
	map_attributes MtWilderness, MT_WILDERNESS, $00,0
	map_attributes ShendoDunkerGate, SHENDO_DUNKER_GATE, $00, 0 
	map_attributes ShendoCity, SHENDO_CITY, $0f, 0