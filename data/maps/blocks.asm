...
Route1Route2Gate_Blocks:
ShendoDunkerGate_Blocks:
...
SilphStore_Blocks:
	INCBIN "maps/SilphStore.blk"

HarpersDunkerGate_Blocks:
	INCBIN "maps/HarpersDunkerGate.blk"
	
HarpersDunkerGate2F_Blocks:
	INCBIN "maps/HarpersDunkerGate2F.blk"

DunkerForest_Blocks:
	INCBIN "maps/DunkerForest.blk"

MtWilderness_Blocks:
	INCBIN "maps/MtWilderness.blk"

UrsaringRun_Blocks:
	INCBIN "maps/UrsaringRun.blk"

ShendoCity_Blocks:
	INCBIN "maps/ShendoCity.asm"
