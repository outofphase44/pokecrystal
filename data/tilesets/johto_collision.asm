	...
	tilecoll FLOOR, WARP_CARPET_RIGHT, FLOOR, WARP_CARPET_RIGHT ; 20
	...
	tilecoll CURRENT_RIGHT, CURRENT_DOWN, CURRENT_RIGHT, CURRENT_DOWN ; 25
	tilecoll WATER, WHIRLPOOL, WATER, WHIRLPOOL ; 26
	tilecoll CURRENT_RIGHT, CURRENT_UP, CURRENT_UP, CURRENT_RIGHT ; 27
	tilecoll WALL, WALL, WALL, DOOR ; 28
	tilecoll CURRENT_RIGHT, CURRENT_RIGHT, CURRENT_DOWN, CURRENT_RIGHT ; 29
	tilecoll CURRENT_RIGHT, CURRENT_UP, CURRENT_RIGHT, CURRENT_DOWN ; 2a
	tilecoll WALL, WALL, WARP_CARPET_LEFT, FLOOR ; 2b
	tilecoll HEADBUTT_TREE, HEADBUTT_TREE, WALL, WALL ; 2c
	tilecoll CURRENT_RIGHT, CURRENT_RIGHT, CURRENT_RIGHT, CURRENT_RIGHT ; 2d
	...
	tilecoll CURRENT_RIGHT, CURRENT_DOWN, CURRENT_RIGHT, CURRENT_DOWN ; 37
	tilecoll WATER, WALL, WALL, WALL ; 38
	tilecoll WATER, WATER, BUOY, BUOY ; 39
	tilecoll WALL, WATER, WALL, WATER ; 3a
	tilecoll CURRENT_RIGHT, CURRENT_RIGHT, CURRENT_RIGHT, CURRENT_RIGHT ; 3b
