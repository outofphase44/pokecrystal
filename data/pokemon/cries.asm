...
; entries correspond to constants/pokemon_constants.asm
	...
	mon_cry CRY_CHIKORITA,     0,  256 ; SHROOMISH
	mon_cry CRY_CHIKORITA,    64,  288 ; BRELOOM
	...
	mon_cry CRY_TEDDIURSA,  1775,  220 ; RIOLU
	mon_cry CRY_TEDDIURSA,  1900,  275 ; LUCARIO
	...
	mon_cry CRY_GOLEM,        70,  275 ; Tangrowth
	...
	mon_cry CRY_PIDGEOT,        0,  256 ; SHELLDER
	mon_cry CRY_PIDGEOT,      111,  352 ; CLOYSTER
	...
	mon_cry CRY_SHROOMISH,         2,  160 ; STARYU
	mon_cry CRY_SHROOMISH,         0,  256 ; STARMIE
	mon_cry CRY_KRABBY,        8,  192 ; MR__MIME
	mon_cry CRY_CATERPIE,      0,  256 ; SCYTHER
	mon_cry CRY_MAGCARGO,   -150,  275 ; MAMOSWINE
	...
	mon_cry CRY_SHROOMISH,       153,  383 ; MEWTWO
	mon_cry CRY_SHROOMISH,       238,  383 ; MEW
	...
	mon_cry CRY_DUNSPARCE,   253,  255 ; DRILBUR
	mon_cry CRY_DUNSPARCE,   320,  325 ; EXCADRILL
	mon_cry CRY_SPINARAK,     17,  512 ; SPINARAK
	mon_cry CRY_SPINARAK,   -174,  482 ; ARIADOS
	mon_cry CRY_SQUIRTLE,    -16,  320 ; CROBAT
	mon_cry CRY_MARILL,      100,  320 ; HONCHKROW
	mon_cry CRY_HOOTHOOT,    205,  300 ; MISMAGIUS
	mon_cry CRY_SPINARAK,     45,  320 ; LAMPENT
	mon_cry CRY_WOOPER,       98,  230 ; WEAVILE
	mon_cry CRY_SPINARAK,     30,  232 ; LITWICK
	...
	mon_cry CRY_WEAVILE,      72,  435 ; FROSLASS
	mon_cry CRY_MARILL,      283,  288 ; MARILL
	mon_cry CRY_MARILL,      182,  384 ; AZUMARILL
	mon_cry CRY_WEAVILE,     3904,  384 ; SUDOWOODO
	mon_cry CRY_WEAVILE,     -675,  456 ; POLITOED
	mon_cry CRY_WEAVILE,       59,  200 ; HOPPIP
	mon_cry CRY_WEAVILE,       39,  312 ; SKIPLOOM
	mon_cry CRY_WEAVILE,        0,  384 ; JUMPLUFF
	...
	mon_cry CRY_HOOTHOOT,    291,  675 ; CHANDELURE
	...
	mon_cry CRY_GLIGAR,      200,  290 ; GLISCOR
	mon_cry CRY_TOGETIC,      90,  100 ; TOGEKISS
	mon_cry CRY_VOLTORB,     315,  350 ; ELECTIVIRE
	mon_cry CRY_METAPOD,       0,  550 ; MAGNEZONE
	...
	mon_cry CRY_AIPOM,      -352,  384 ; ABSOL
	mon_cry CRY_PICHU,      -538,  496 ; SMEARGLE
	mon_cry CRY_AIPOM,        44,  264 ; TYROGUE
	mon_cry CRY_EKANS,       258,  340 ; SEVIPER
	mon_cry CRY_TOTODILE,     70,  215 ; YANMEGA
	mon_cry CRY_GIRAFARIG,    88,  576 ; Porygon_Z
	mon_cry CRY_CHARMANDER,  275,  188 ; MAGMORTAR
	...
	mon_cry CRY_RHYDON,      325,  430 ; 252
