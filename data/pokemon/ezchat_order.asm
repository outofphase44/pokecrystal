...
.e:        db SKARMORY, AIPOM, ESPEON, HITMONCHAN, PORYGON_Z, ELECTABUZZ, ENTEI, -1
.o:        db FERALIGATR, FURRET, ELECTIVIRE, PRIMEAPE, SENTRET, OMASTAR, OMANYTE, -1
.ka_ga:    db GROWLITHE, MACHAMP, DRAGONITE, PINSIR, SNORLAX, KABUTO, KABUTOPS, WARTORTLE, BLASTOISE, TANGROWTH, CUBONE, MAROWAK, KANGASKHAN, -1
...
.sa_za:    db RHYHORN, PUPITAR, GLISCOR, HITMONLEE, ZAPDOS, JOLTEON, SANDSHREW, SANDSLASH, -1 ; RHYDON should lead this list
...
.chi_dhi:  db CHIKORITA, HONCHKROW, -1
.tsu_du:   db SHUCKLE, -1
.te_de:    db DIGLETT,  MAGNEZONE, HOUNDOUR, AMPHAROS, -1
.to_do:    db DODUO, DODRIO, SMEARGLE, KOFFING, TENTACRUEL, TOGETIC, TOGEPI,  METAPOD, DONPHAN, -1
...
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db SEEL, STEELIX, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, BLISSEY, MR__MIME, TYROGUE, CLOYSTER, TYRANITAR, -1
.hi_bi_pi: db WEAVILE, WEEDLE, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, CLEFAIRY, CHARMANDER, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, -1
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, FORRETRESS, WIGGLYTUFF, IVYSAUR, BULBASAUR, VENUSAUR, AERODACTYL, MAGMORTAR, UMBREON, ARTICUNO, JIGGLYPUFF, SNUBBULL, -1
...
.ra:       db RAIKOU, RAICHU, CHANSEY, RATICATE, LAPRAS, VILEPLUME, MISMAGIUS, -1
.ri:       db CHARMELEON, CHARIZARD, URSARING, -1
.ru:       db MAMOSWINE, LUGIA, -1
.re:       db MAGNETON, -1
.ro:       db VULPIX, -1
