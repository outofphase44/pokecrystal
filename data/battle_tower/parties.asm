...
BattleTowerMons1:
	...
	db ESPEON
	db LEFTOVERS
	db MUDSLIDE, PSYCHIC_M, NASTY_PLOT, TOXIC
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db UMBREON
	db GOLD_BERRY
	db SHADOW_BALL, IRON_TAIL, NASTY_PLOT, TOXIC
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db GLISCOR
	db SCOPE_LENS
	db EARTHQUAKE, WING_ATTACK, POISON_STING, HARDEN
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db AERODACTYL
	db LEFTOVERS
	db HYPER_BEAM, SUPERSONIC, EARTHQUAKE, NIGHT_SLASH
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db HOUNDOUR
	db GOLD_BERRY
	db JAB, SOLARBEAM, ROAR, SUNNY_DAY
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db GIRAFARIG
	db KINGS_ROCK
	db PSYBEAM, MUDSLIDE, SHADOW_BALL, AGILITY
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db HERACROSS
	db GOLD_BERRY
	db REVERSAL, BATTERY, COUNTER, ROCK_SMASH
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db TAUROS
	db KINGS_ROCK
	db HEADBUTT, SWAGGER, NOVA_BOMB, ICY_WIND
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db MR__MIME
	db QUICK_CLAW
	db TOXIC, NASTY_PLOT, FIRE_PUNCH, HEADBUTT
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons2:
	...
	db UMBREON
	db LEFTOVERS
	db PROTECT, TOXIC, MUDSLIDE, ATTRACT
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db STARMIE
	db GOLD_BERRY
	db RECOVER, PSYCHIC_M, SURF, NASTY_PLOT
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ALAKAZAM
	db BERRY_JUICE
	db PSYCHIC_M, NASTY_PLOT, TOXIC, THUNDERPUNCH
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db HERACROSS
	db FOCUS_BAND
	db BATTERY, REVERSAL, MEGAHORN, EARTHQUAKE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db BLISSEY
	db BRIGHTPOWDER
	db PSYCHIC_M, JAGGED_EDGE, SOFTBOILED, COUNTER
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db HITMONCHAN
	db GOLD_BERRY
	db THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, LAVA_PLUME
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db WIGGLYTUFF
	db PINK_BOW
	db PSYCHIC_M, SWAGGER, NASTY_PLOT, HEADBUTT
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons3:
	...
	db JOLTEON
	db MIRACLEBERRY
	db THUNDERBOLT, THUNDER_WAVE, ROAR, MUDSLIDE
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db POLIWRATH
	db BRIGHTPOWDER
	db BULLET_PUNCH, SURF, FISSURE, JAGGED_EDGE
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db DUGTRIO
	db KINGS_ROCK
	db EARTHQUAKE, SLUDGE_BOMB, SLASH, MUDSLIDE
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db FROSLASS
	db BRIGHTPOWDER
	db GIGA_DRAIN, SUNNY_DAY, SOLARBEAM, BULLET_PUNCH
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db MISMAGIUS
	db GOLD_BERRY
	db RAIN_DANCE, THUNDER, SURF, ICICLE_SPEAR
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ESPEON
	db MIRACLEBERRY
	db CONFUSION, SWIFT, TOXIC, NASTY_PLOT
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db TENTACRUEL
	db KINGS_ROCK
	db SUBMISSION, TOXIC, SLUDGE_BOMB, BUBBLEBEAM
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons4:
	...
	db SNORLAX
	db QUICK_CLAW
	db ATTRACT, BODY_SLAM, NASTY_PLOT, EARTHQUAKE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GOLEM
	db FOCUS_BAND
	db EXPLOSION, EARTHQUAKE, LAVA_PLUME, ROCK_SLIDE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db DUGTRIO
	db KINGS_ROCK
	db EARTHQUAKE, HYPER_BEAM, SLUDGE_BOMB, MUDSLIDE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db CHARIZARD
	db KINGS_ROCK
	db WILL_O_WISP, DRAGON_RAGE, FLY, SLASH
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db EXEGGUTOR
	db BRIGHTPOWDER
	db BUG_BITE, STOMP, NASTY_PLOT, CONFUSION
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons5:
	...
	db SHUCKLE
	db LEFTOVERS
	db SANDSTORM, REST, TOXIC, SUBMISSION
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db SNORLAX
	db LEFTOVERS
	db HYPER_BEAM, EARTHQUAKE, SURF, NASTY_PLOT
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db SCIZOR
	db LEFTOVERS
	db HYPER_BEAM, SLASH, AGILITY, STORMTRANCE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 45000
...
BattleTowerMons6:
	...
	db UMBREON
	db GOLD_BERRY
	db MUDSLIDE, MOONLIGHT, PSYCHIC_M, JAB
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons7:
	...
	db VAPOREON
	db LEFTOVERS
	db BLIZZARD, SHADOW_BALL, SURF, MUDSLIDE
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db UMBREON
	db GOLD_BERRY
	db JAB, MOONLIGHT, NASTY_PLOT, TOXIC
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 54000
	...
	db HOUNDOOM
	db KINGS_ROCK
	db CRUNCH, FLAMETHROWER, JAB, ROAR
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 58000
	...
	db UMBREON
	db GOLD_BERRY
	db MOONLIGHT, JAB, PSYCHIC_M, SHADOW_BALL
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db HITMONLEE
	db FOCUS_BAND
	db REVERSAL, BATTERY, BODY_SLAM, MEGA_KICK
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db HERACROSS
	db BRIGHTPOWDER
	db REVERSAL, BATTERY, MEGAHORN, EARTHQUAKE
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons8:
	...
	db SKARMORY
	db QUICK_CLAW
	db STEEL_WING, FLY, MUDSLIDE, TOXIC
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db DUGTRIO
	db SCOPE_LENS
	db SLASH, EARTHQUAKE, THIEF, MUDSLIDE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db PINSIR
	db GOLD_BERRY
	db HYPER_BEAM, JAGGED_EDGE, STRENGTH, TOXIC
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons9:
	...
	db UMBREON
	db KINGS_ROCK
	db JAB, MUDSLIDE, MOONLIGHT, CONFUSE_RAY
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db MACHAMP
	db QUICK_CLAW
	db CROSS_CHOP, AVALANCHE, FIRE_BLAST, EARTHQUAKE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db SHUCKLE
	db LEFTOVERS
	db TOXIC, SUBMISSION, PROTECT, ENCORE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons10:
	...
	db MACHAMP
	db QUICK_CLAW
	db CROSS_CHOP, EARTHQUAKE, HYPER_BEAM, AVALANCHE
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db PIDGEOT
	db KINGS_ROCK
	db DRILL_PECK, STEEL_WING, HYPER_BEAM, MUDSLIDE
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db SNEASEL
	db SCOPE_LENS
	db SLASH, BLIZZARD, DREAM_EATER, JAB
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
