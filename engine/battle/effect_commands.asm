...
; applydamage
	...
	ld a, BATTLE_VARS_SUBSTATUS1_OPP
	call GetBattleVar
	bit SUBSTATUS_BATTERY, a
	jr z, .focus_band

	call BattleCommand_Petrify
	ld b, 0
	jr nc, .damage
	ld b, 1
	jr .damage
...
; PlateShift and Explosion halve defense.
	cp EFFECT_PLATE_SHIFT
...
.skip_to_divide
	...
	ldh a, [hQuotient + 3]
	ld b, a
	ld hl, IcicleSpearReversalPower
...
.Traps:
	dbw POLARITY,      UsedPolarityText      ; 'used POLARITY on'
	dbw SUBMISSION,      SubmissionedByText     ; 'was SUBMIT by'
...
BattleCommand_DoubleScaldDamage:
