...
Battle_EnemyFirst:
	...
	jr c, .switch_item
	call EnemyTurn_EndOpponentProtectBatteryDestinyBond
	call CheckMobileBattleError
	ret c
	ld a, [wForcedSwitch]
	and a
...
.switch_item
	...
	call PlayerTurn_EndOpponentProtectBatteryDestinyBond
	call CheckMobileBattleError
	ret c
	ld a, [wForcedSwitch]
	and a
...
PlayerTurn_EndOpponentProtectBatteryDestinyBond:
	call SetPlayerTurn
	call EndUserDestinyBond
	callfar DoPlayerTurn
	jp EndOpponentProtectBatteryDestinyBond

EnemyTurn_EndOpponentProtectBatteryDestinyBond:
	call SetEnemyTurn
	call EndUserDestinyBond
	callfar DoEnemyTurn
	jp EndOpponentProtectBatteryDestinyBond

EndOpponentProtectBatteryDestinyBond:
	ld a, BATTLE_VARS_SUBSTATUS1_OPP
	call GetBattleVarAddr
	res SUBSTATUS_PROTECT, [hl]
	res SUBSTATUS_BATTERY, [hl]
...
.skip_inc
	...
	ld a, 1
	ld [w2DMenuNumCols], a
	ld c, STATICMENU_ENABLE_LEFT_RIGHT | STATICMENU_ENABLE_START | STATICMENU_SUBMISSION
	ld a, [wMoveSelectionMenuType]
	dec a
...
; Swap badges 3 (PlainBadge) and 5 (MineralBadge).
	...
	ld c, a
	ld a, d
	and ((1 << BLOOMBADGE) | (1 << HIVEBADGE) | (1 << FOGBADGE) | (1 << STORMBADGE) | (1 << GLACIERBADGE) | (1 << RISINGBADGE))
	or b
	or c
	ld b, a
