...
.table_386f2
	...
	dbw EFFECT_PLATE_SHIFT,     AI_Smart_PlateShift
	...
	dbw EFFECT_BATTERY,           AI_Smart_Battery
	...
	dbw EFFECT_NASTY_PLOT,         AI_Smart_NastyPlot
	dbw EFFECT_MIRROR_COAT,      AI_Smart_MirrorCoat
	dbw EFFECT_SHELL_BASH,       AI_Smart_ShellBash
...
AI_Smart_TrapTarget:
; Polarity, Submission, Fire Spin, Clamp
...
; trapped (Polarity effect), seeded, or scattered with spikes.
...
AI_Smart_Stomp:
; 80% chance to encourage this move if the player has used Scald.
