...
InitializeEventsScript:
	...
	setevent EVENT_ILEX_FOREST_CHARMANDER
	...
	setevent EVENT_MR_JACKSON_VISIBLE_IN_CHERRYGROVE
	setevent EVENT_CEDARS_AIDE_IN_VIOLET_POKEMON_CENTER
	setevent EVENT_COP_IN_CEDARS_LAB
	...
	setevent EVENT_GATE_OF_JOHTO_0F_SCIZOR
