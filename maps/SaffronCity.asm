...
SaffronCity_MapEvents:
	...
	warp_event 13, 29, SAFFRON_MART, 2
	...
	warp_event 25, 21, SILPH_STORE, 1
	db 0 ; coord events
	...
	bg_event 14, 29, BGEVENT_READ, SaffronCityMartSign
	...
	object_event 19,  7, SPRITE_LASS, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, SaffronCityLass2Script, -1
