...
MrPokemonsHouse_OakScript:
	...
	setmapscene HARPERS_TOWN, SCENE_HARPERSTOWN_MEET_RIVAL
	setmapscene CEDARS_LAB, SCENE_CEDARSLAB_MEET_OFFICER
	specialphonecall SPECIALCALL_ROBBED
	clearevent EVENT_COP_IN_CEDARS_LAB
	checkevent EVENT_GOT_STARYU_FROM_CEDAR
	iftrue .RivalTakesChikorita
	checkevent EVENT_GOT_ELECTABUZZ_FROM_CEDAR
	iftrue .RivalTakesCyndaquil
	setevent EVENT_STARYU_POKEBALL_IN_CEDARS_LAB
	end

.RivalTakesChikorita:
	setevent EVENT_ELECTABUZZ_POKEBALL_IN_CEDARS_LAB
	end

.RivalTakesCyndaquil:
	setevent EVENT_MAGMAR_POKEBALL_IN_CEDARS_LAB
	end
...
MrPokemonIntroText1:
	...
	para "PROF.CEDAR said that"
	line "you would visit."
	done

MrPokemonIntroText2:
	text "This is what I"
	line "want PROF.CEDAR to"
	cont "examine."
	done
...
MrPokemonsHouse_OakText1:
	...
	line "PROF.CEDAR gave you"

	para "a #MON for this"
	line "errand."

	para "To researchers"
	line "like PROF.CEDAR and"
