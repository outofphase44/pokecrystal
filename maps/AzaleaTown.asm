...
AzaleaTownRivalBattleScript:
	...
	checkevent EVENT_GOT_STARYU_FROM_CEDAR
	iftrue .Totodile
	checkevent EVENT_GOT_ELECTABUZZ_FROM_CEDAR
	iftrue .Chikorita
	winlosstext AzaleaTownRivalWinText, AzaleaTownRivalLossText
	setlasttalked AZALEATOWN_SILVER
	loadtrainer RIVAL1, RIVAL1_2_STARYU
	startbattle
	dontrestartmapmusic
...
.Totodile:
	winlosstext AzaleaTownRivalWinText, AzaleaTownRivalLossText
	setlasttalked AZALEATOWN_SILVER
	loadtrainer RIVAL1, RIVAL1_2_ELECTABUZZ
	startbattle
	dontrestartmapmusic
	reloadmapafterbattle
	sjump .AfterBattle
...
.Chikorita:
	winlosstext AzaleaTownRivalWinText, AzaleaTownRivalLossText
	setlasttalked AZALEATOWN_SILVER
	loadtrainer RIVAL1, RIVAL1_2_MAGMAR
	startbattle
	dontrestartmapmusic
	reloadmapafterbattle
	sjump .AfterBattle
...
WhiteApricornTree:
	fruittree AZALEATOWN_FRUIT_TREE

BlackApricornTree:
	fruittree AZALEATOWN_FRUIT_TREE2

PinkApricornTree:
	fruittree AZALEATOWN_FRUIT_TREE3

GreenApricornTree:
	fruittree AZALEATOWN_FRUIT_TREE4
...
AzaleaTown_MapEvents:
	...
	object_event 17,  3, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AzaleaTownSlowpokeScript, EVENT_AZALEA_TOWN_SLOWPOKES
	...
	object_event 10,  2, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, WhiteApricornTree, -1
	object_event 10,  4, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BlackApricornTree, -1
	object_event 13,  2, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, PinkApricornTree, -1
	object_event 13,  4, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GreenApricornTree, -1
