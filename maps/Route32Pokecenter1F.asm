...
Route32Pokecenter1FFishingGuruScript:
	faceplayer
	opentext
	checkevent EVENT_GOT_RIVER_ROD
	iftrue .GotRiverRod
	...
	promptbutton
	verbosegiveitem RIVER_ROD
	writetext Route32Pokecenter1FFishingGuruText_GiveRiverRod
	waitbutton
	closetext
	setevent EVENT_GOT_RIVER_ROD
	end
...
Route32Pokecenter1FFishingGuruText_GiveRiverRod:
