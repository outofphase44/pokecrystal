...
SlowpokeWellB2FTMRainDance:
	itemball EVENT_SLOWPOKE_WELL_B2F_TM_DREADNAUGHT
...
SlowpokeWellB2F_MapEvents:
	...
	object_event 15,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SlowpokeWellB2FTMRainDance, EVENT_SLOWPOKE_WELL_B2F_TM_DREADNAUGHT
