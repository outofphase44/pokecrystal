...
TilesetGateOfJohtoGFX::
INCBIN "gfx/tilesets/gate_of_johto.2bpp.lz"

TilesetGateOfJohtoMeta::
INCBIN "data/tilesets/gate_of_johto_metatiles.bin"

TilesetGateOfJohtoColl::
INCLUDE "data/tilesets/gate_of_johto_collision.asm"

TilesetShendoGFX::
INCBIN "gfx/tilesets/shendo.2bpp.lz"

TilesetShendoMeta::
INCBIN "data/tilesets/shendo_metatiles.bin"

TilesetShendoColl::
INCLUDE "data/tilesets/shendo_collision.asm"
